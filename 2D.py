...
# Suavitzar amb filtre gausia per crear el anti-aliasing
...
# Nou FRACTAL 2D: Cantor 2D suavizado
...
print(f"  ANÀLISI FD 2D {mostra} FET")
print(f"FD2D = {FD2D:.3f}")
print(f"R²   = {r2:.3f}")
print(f"Resultats guardatss a: {output_folder}")
